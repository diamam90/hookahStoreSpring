                        ...
                        <div class="block-action-header language-switcher pull-right">
                            <div class="textwidget">
                                <div id="lang_sel">
                                    <ul class="nav">
                                        <li>
                                            <a class="lang_sel_sel icl-en" href="#">RUS
                                            </a>
                                            <ul>
                            ...
                            <ul class="currency_w">
                                <li>
                                    ...
                                    <ul class="currency_switcher">
                                        <li>
                                            <a href="#" class="reset default active" data-currencycode="USD">RUB</a>
                                        </li>
                                        <li>
                                            <a href="#" data-currencycode="EUR">USD</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                            ...
                            <div class="mini-cart-header">
                                <div class="top-form top-form-minicart minicart-product-style pull-right">
                                    <div class="top-minicart pull-right">
                                        <a class="cart-contents" href="/shopping-cart" title="Просмотр корзины">
                                            <c:choose>
